...
import { WeeklyCategoryTarget, SubjectGoal, UserPersonalization, LessonStatus, StreakDayRecord } from '../types';
...
export const ProgressDashboard: React.FC<ProgressDashboardProps> = ({
  ...
  const filteredCategories = categoryTargets.filter((c) => {
    if (chartCategoryFilter === 'core') {
      return c.id === 'bangre_neo' || c.id === 'cinema' || c.id === 'school';
    }
    return true;
  });
  ...
  const categoryChartData = filteredCategories.map((c) => {
    ...
    return {
      ...
      percentage: Math.round((c.completedHours / c.targetHours) * 100),
    };
  });
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-xs text-slate-300 mt-2 max-w-2xl leading-relaxed">
              Suivez vos objectifs hebdomadaires en temps réel : <strong>Bangre Neo (15-20h)</strong>, <strong>Cinéma (10-15h)</strong>, <strong>Études (5-10h avec SVT, Maths, PC, Hist-Géo)</strong>, et <strong>Travail Incontournable</strong>.
            </p>
          </div>
      ...
      {/* Real Academic Syllabus & Lesson Tracker */}
      <div className="bg-card border border-soft rounded-xl p-6 space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-soft pb-4">
          <div>
            <div className="flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 bg-card border border-soft rounded-xl p-6 space-y-4">
          ...
          <p className="text-xs text-slate-300 leading-relaxed">
            Comparaison directe entre heures enregistrées et objectifs hebdomadaires : <strong>Bangre Neo Lab (15-20h)</strong>, <strong>Cinéma (10-15h)</strong>, et <strong>Études (5-10h)</strong>.
          </p>
