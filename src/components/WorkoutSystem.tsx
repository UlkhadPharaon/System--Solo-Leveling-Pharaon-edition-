...
export const WorkoutSystem: React.FC<WorkoutSystemProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'programs' | 'active_session' | 'progress' | 'history'>('programs');
        ...
        <div className="relative z-10 flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl lg:text-3xl font-light tracking-tight text-slate-100 font-display">
              Centre de <span className="text-cyan-400 font-medium">Musculation & Condition Physique</span>
            </h1>
