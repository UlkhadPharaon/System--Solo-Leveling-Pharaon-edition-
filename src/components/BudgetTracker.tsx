...
export const BudgetTracker: React.FC<BudgetTrackerProps> = ({
  ...
  const [txBucket, setTxBucket] = useState<MoneyFlowBucket>('bangre_neo_tech');
  ...
  const [goalBucket, setGoalBucket] = useState<MoneyFlowBucket>('cinema_production');
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-xs text-slate-300 mt-2 max-w-2xl leading-relaxed">
              Suivez les flux de revenus réels, affectez les allocations de capital à <strong>Bangre Neo Tech</strong>, <strong>Production Cinéma</strong>, <strong>Préparation Académique</strong>, et surveillez vos réserves d'épargne.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-soft pb-4">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            >
              ...
              <option value="bangre_neo_tech">Bangre Neo</option>
              <option value="cinema_production">Cinéma</option>
              <option value="school_education">Scolaire</option>
              <option value="savings_investment">Épargne</option>
              <option value="living_essentials">Quotidien</option>
            </select>
          </div>
        </div>
            ...
            <form onSubmit={handleCreateTransaction} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  >
                    <option value="bangre_neo_tech">Bangre Neo Tech</option>
                    <option value="cinema_production">Cinéma & Scénarios</option>
                    <option value="school_education">Études Académiques</option>
                    <option value="savings_investment">Épargne & Réserves</option>
                    <option value="living_essentials">Dépenses Essentielles</option>
                  </select>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  >
                    ...
                    <option value="bangre_neo_tech">Bangre Neo Tech</option>
                    <option value="savings_investment">Épargne & Réserves</option>
                    <option value="school_education">Fournitures Académiques</option>
                  </select>
                </div>
